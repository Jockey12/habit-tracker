...
export default function Home() {
  return (
    <div className="font-sans min-h-screen flex flex-col items-center p-8">
      ...
      <span className="font-bold text-black text-3xl mb-4">Welcome to Habit Tracker</span>
      <p className="w-full max-w-xl flex flex-col gap-8 mt-8 text-black">Habit tracker is a simple app to track your daily habits. It allows you to add, mark, and view your habits in a user-friendly interface. The app is built with Next.js and Tailwind CSS for a modern look and feel.</p>
